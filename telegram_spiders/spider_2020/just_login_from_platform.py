...
log = Logger('just_login_from_platform.log')
...
async def login(phone):
    ...
    if await client.is_user_authorized():
        ...
        # log.logger.info(str(phone) + "登录成功！")
